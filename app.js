...
class GeoGame {
    ...
    resetGame() {
        ...
        qPanel.querySelector('#sub-text').textContent = "Hrajeme nekonečně, dokud tě to baví!";
    ...
    nextQuestion() {
        ...
        // Pick random target (avoiding last 5 targets)
    ...
    setupIdentifyMode() {
        ...
        document.getElementById('sub-text').textContent = "Vyber z nabídky herní mapy";
    ...
    setupTypeinMode() {
        ...
        document.getElementById('sub-text').textContent = "Jak se jmenuje označené místo?";
    ...
    checkTypeinAnswer() {
        ...
        // Simple normalization for Czech accents (optional but helpful)
